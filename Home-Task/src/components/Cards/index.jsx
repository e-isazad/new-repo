...
const Cardsx = () => {
    const {bira, setBira} = useContext(CardsContextt);
    const {detailsVisible, setDetailsVisible} = useContext(CardsContextt);
    const {selectedBira, setSelectedBira} = useContext(CardsContextt);
